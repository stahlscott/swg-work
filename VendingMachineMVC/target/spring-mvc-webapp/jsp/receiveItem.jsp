            ...
            <div class="jumbotron text-center">
                <h2>
                    <c:if test="${!empty successMsg}">
                        ...
                        <div>
                            <img id="ilya-left" src="${pageContext.request.contextPath}/img/vendingmachine.jpg" width="200"/>
                            <img id="product" src="${pageContext.request.contextPath}/${imgUrl}" width="250"/>
                            <img id="ilya-right" src="${pageContext.request.contextPath}/img/vendingmachiner.jpg" width="200"/>
                            <br/>
                            <span class="label label-danger" id="das" style="display:none">
                                до свидания!!!
                            </span><br/><br/>
                            <!--<iframe width="200" height="200" src="https://www.youtube.com/embed/3JnEZU6h-ko?autoplay=1" frameborder="0" autoplay="1" style="display:none"></iframe>-->
                        </div>
                    </c:if>
