...
import com.tsg.flooringmasteryspring.ui.ConsoleIOInterface;
...
import com.tsg.flooringmasteryspring.dao.OrderDAOInterface;
...
public class FlooringController {
    ...
    private ConsoleIOInterface con;
     ...
     * @param orderMaker
     */
    public FlooringController(ConsoleIOInterface con, ProductDAOInterface productDAO, TaxDAOInterface taxDAO, OrderDAOInterface orderDAO, OrderMaker orderMaker) {
        this.con = con;
...
//            orderMaker = new OrderMaker(taxDAO, productDAO);
    ...
    /**
     * Gets product type from user, forces a valid answer matching product types loaded into ProductDAOImpl
     *
    ...
    /**
     * Gets state name from user, forces a valid answer matching States loaded into TaxDAOImpl
     *
     * @param prompt String request to display to user
     * @param allowBlank if a blank response is allowed
